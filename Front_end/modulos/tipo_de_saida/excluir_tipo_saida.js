    ...
    if (confirmacao) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                let dados = await buscarDados('tipos_saida'); // Busca os dados da tabela, exibe na tela e permite pesquisar
                carregarDadosNaTabela(dados, ["id_tipo_de_saida", "descricao", "cfop_dentro","cfop_fora","ativo"]) // Exibe na tela e permite pesquisar
            }
        } catch (err) {
            popup_carregando(true)
